This directory contains sound files for deployment as imintty bell sounds.
...
[how to make bell sounds](https://github.com/imintty/imintty/issues/711#issuecomment-483074839) 
...
(e.g. in `$HOME/.config/imintty` or `$APPDATA/imintty`).
